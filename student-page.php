		...
		<div class="row"> 
			...
			<div class="col-md-9"> 
				<div class="about-us-content">
					...
					<form action="" class="form-inline pull-right"><input type="search" name="search" id="" placeholder="Search Roll" class="form-control" /></form>
					
					</div>
					<div class="deprtment-title"> 
						<h2 style="text-transform:uppercase"><?php echo $db->get('student_page', ['page_title', '=', $department])->first()->page_title;?></h2>
					</div>
					...
					<table class="table table-bordered"> 
						...
						<tbody>
							<?php 
									...
									foreach($db->get('student', ['department', '=', $department])->result() as $row){
									?>
									<tr>
